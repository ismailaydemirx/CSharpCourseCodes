...
namespace Decorator
{
    ...
    {
        public abstract string Make { get; set; } // abstract yapmamızın sebebi bunu inherit eden class'larda bu fonksiyonları override edebilmek.
    ...
    abstract class CarDecaratorBase : CarBase
    {
        ...
        protected CarDecaratorBase(CarBase carBase) // Constructor oluşturduk.
        {
            _carBase = carBase;
        }
    }
    ...
    class SpecialOffer : CarDecaratorBase
    {
        ...
        public SpecialOffer(CarBase carBase) : base(carBase) // CarDecoratorBase bir constructor'a ihtiyaç duyduğu için bunu eklemek zorundayız. Çünkü CarDecoratorBase'i inherit ettik.
        {
            _carBase = carBase;
        }
