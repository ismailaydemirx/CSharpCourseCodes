...
namespace Strategy
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            customerManager.CreditCalculatorBase = new After2010CreditCalculator(); // bunu yapmayı unutmuyoruz.
            customerManager.SaveCredit();


            customerManager.CreditCalculatorBase = new Before2010CreditCalculator(); // bunu yapmayı unutmuyoruz.
            customerManager.SaveCredit();
