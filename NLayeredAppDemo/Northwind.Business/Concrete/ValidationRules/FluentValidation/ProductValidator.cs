...
namespace Northwind.Business.Concrete.ValidationRules.FluentValidation
{
    ...
    {
        //Fluent Validation Dokümantasyonunu inceleyebilirsin.
        public ProductValidator()
        {
            ...
            RuleFor(p => p.UnitPrice).GreaterThan(10).When(p => p.CategoryId == 2);//CategoryId'si 2 olan ürünün fiyatı 10'dan büyük olmalı.
